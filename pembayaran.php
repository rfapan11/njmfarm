	...
	<div class="container">
		...
		<form method="post" enctype="multipart/form-data" >
			...
			<div class="form-group">
				...
				<p class="text-danger">Foto Bukti Harus JPG Maksial 2MB</p>

			</div>

			<button class="btn btn-primary" name="kirim"><span class="glyphicon glyphicon-floppy-saved"></span> Kirim</button>
...

{
	...
	// update data pembelianya dari pending menjadi sudah melakukan pembayaran
	$koneksi->query("UPDATE pembelian SET status_pembelian='Diperiksa'
